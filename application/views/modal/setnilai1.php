		...
		<tr>
			...
			<td><div class="radio radio-primary">
			   <?php $cikcek = 0; foreach ($nilai as $keyn) {
                  ...
                  <input <?php if($cikcek > 0) { echo ""; } ?> <?php if(date ("Y-m-d", strtotime("-1 day", strtotime($today))) > $hariini) { echo ""; } ?> name="<?php echo $hariini; ?>" <?php foreach ($nilai as $keyn) { if ($hariini == $keyn->tgl && $keyn->sub_id == 0) { echo 'checked = "checked"'; echo 'title="'.$keyn->ket.'"'; } } ?> type="radio" id="<?php echo $hariini; ?>.ok" value="<?php echo $hariini.".0"; ?>" onclick="lancar(this.id)">
            ...
            <td>
               <div class="radio radio-primary">
                  <?php 
                     ...
                     ?> <?php if(date ("Y-m-d", strtotime("-1 day", strtotime($today))) > $hariini) { echo ""; } ?> type="radio" onclick="pencet(this.id)" id="<?php echo $hariini.".".$keysub->id_sub.".".$karyawan->id_karyawan;?>" name="<?php echo $hariini.$key->nama;?>">
